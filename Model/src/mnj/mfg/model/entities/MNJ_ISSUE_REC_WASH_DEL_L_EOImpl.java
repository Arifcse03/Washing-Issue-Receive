...
// ---    Tue Feb 21 12:45:29 PKT 2017
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class MNJ_ISSUE_REC_WASH_DEL_L_EOImpl extends EntityImpl {
    ...
    public enum AttributesEnum {
        IrHeaderId {
            public Object get(MNJ_ISSUE_REC_WASH_DEL_L_EOImpl obj) {
                return obj.getIrHeaderId();
            }

            public void put(MNJ_ISSUE_REC_WASH_DEL_L_EOImpl obj,
                            Object value) {
        ...
        ,
        MNJ_ISSUEREC_WASH_DEL_SIZE_EO {
            public Object get(MNJ_ISSUE_REC_WASH_DEL_L_EOImpl obj) {
                return obj.getMNJ_ISSUEREC_WASH_DEL_SIZE_EO();
            }
        ...
        public abstract Object get(MNJ_ISSUE_REC_WASH_DEL_L_EOImpl object);

        public abstract void put(MNJ_ISSUE_REC_WASH_DEL_L_EOImpl object,
                                 Object value);
    ...
    public static final int MNJ_ISSUEREC_WASH_DEL_SIZE_EO = AttributesEnum.MNJ_ISSUEREC_WASH_DEL_SIZE_EO.index();

    /**
     * This is the default constructor (do not remove).
     */
    public MNJ_ISSUE_REC_WASH_DEL_L_EOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = EntityDefImpl.findDefObject("mnj.mfg.model.entities.MNJ_ISSUE_REC_WASH_DEL_L_EO");
        }
     ...
     */
    public RowIterator getMNJ_ISSUEREC_WASH_DEL_SIZE_EO() {
        return (RowIterator)getAttributeInternal(MNJ_ISSUEREC_WASH_DEL_SIZE_EO);
    }
    ...
    protected void create(AttributeList attributeList) {
        ...
        oracle.jbo.server.SequenceImpl s =
            new oracle.jbo.server.SequenceImpl("MNJ_ISSUE_REC_WASH_DEL_L_S",
                                               getDBTransaction());
